  ...
  const { count, rows } = await Asset.findAndCountAll({
    ...
    include: [
      ...
      tokenizationInclude,
      {
        ...
        as:       'auctions',
        required: false,
        attributes: ['id', 'status', 'startDate', 'startTime', 'endDate', 'endTime', 'timezone', 'onChainAuctionId', 'showCountdown', 'reservePrice', 'startingBidPrice', 'minIncrement', 'createdAt', 'settlementStatus'],
